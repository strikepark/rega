var UserEditView = Backbone.View.extend({
    el: $('.content'),
    userEditTpl: _.template($('#user_edit').html()),
    ...
    render: function () {
        this.$el.append(this.userEditTpl(this.model.toJSON()));
        return this;
    },
    ...
    routeToUsers: function (event) {
        ...
        if (this.model.get('isStaff')) {
            router.navigate("users/organizers", {trigger: true});
        } else {
    ...
    addUser: function (event) {
        ...
        if(error) {
            $('.fp-field__button').html('Сохранить');
            ...
            this.model.save(formData, {
                success: function(model, response) {
                    ...
                    if (model.get('isStaff')) {
                        $('.content').prepend('<div class=\'fp-alert fp-alert--success\'><div class=\'fp-alert__text\'>Данные участника обновились. Перейти к <a class=\'fp-alert__text__link\' href=\'/#users/organizers\'>списку организаторов.</a></div><div class=\'fp-alert__close\'></div>');
                    } else {
                        $('.content').prepend('<div class=\'fp-alert fp-alert--success\'><div class=\'fp-alert__text\'>Данные участника обновились. Перейти к <a class=\'fp-alert__text__link\' href=\'/#users/attendees\'>списку участников.</a></div><div class=\'fp-alert__close\'></div>');
                    }
                ...
                error: function(model, response) {
                    ...
                    window.scrollTo(0,0);
                    $('.content').find('.fp-alert').remove();
                    $('.content').prepend('<div class=\'fp-alert fp-alert--error\'><div class=\'fp-alert__text\'>Произошла ошибка, данные не дошли до сервера. Попробуйте сохранить пользователя позже.</div><div class=\'fp-alert__close\'></div>');
                    $('.fp-alert').slideDown(500);
                },
                wait: true
            });
